...
student = (name = "Austin Nguyen", kerberos_id = "austinnguyen153")
...
function create_bar()
	...
	n = 100
	vec = zeros(n) 
	replace = @view vec[50-10:50+10]
	#replace = @view vec[40:60]
	replace .= 1 
	return vec
end
...
# ╔═╡ eddfb310-7ed0-11eb-2327-95e4779e2524
...
# ╔═╡ 6b0a3010-7fb5-11eb-123a-7dc674c6cc47
...
# ╔═╡ ed01ac10-7fb5-11eb-382c-bdf2f355b51f
...
# ╔═╡ de447a90-7fb5-11eb-17b7-458d7194afd9
function get_blue(pixel::AbstractRGB)
	# your code here!
	return pixel.b
end

# ╔═╡ fc452490-7fb5-11eb-2510-c52db04e9d88
...
function noisify(x::Number, s)
	# your code here!
	return s==0 ? x : clamp(x+rand(-s: s/100 :s), 0, 1)
end
...
function noisify(image::AbstractMatrix, s)
	...
	# *** Using comprehension
	# return noisify(image[i,j], s) for i in image[:], j in image[:] 
end
...
@bind philip_noise Slider(0:0.01:3, show_value=true)
...
# ╔═╡ d11035ee-8058-11eb-23ff-2bb63d049334
@bind webcam_noise Slider(0:0.01:1, show_value=true)
...
function custom_filter(pixel::AbstractRGB)
	...
	return noisify(pixel, webcam_noise)
end
