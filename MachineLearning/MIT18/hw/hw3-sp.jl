...
# ╔═╡ 118ce9c0-923d-11eb-09aa-f551eec04b72
lowercase(messy_sentence_2)
...
# ╔═╡ 7bca1460-9306-11eb-0d95-05dbd8060bfe
count("l", "Hello World")

# ╔═╡ 8bce046e-930b-11eb-2a80-c15d520f1832
@which count("l", "Hello World")

# ╔═╡ 7e2c956e-9306-11eb-3dae-67942db8639b
string.(alphabet)
...
# ╔═╡ 76c67710-9310-11eb-348e-674936a0d646
alphabet
...
# ╔═╡ 444c4780-9318-11eb-3079-415b1eee528f
double_letters = ['e', 'l','m', 'o','r','s',' '] # replace with your answer
...
# ╔═╡ 5f960020-931e-11eb-1425-fd2fca318e34
view(sample_freq_matrix, index_of_letter('w'), :)

# ╔═╡ 7898b76a-f930-11ea-2b7e-8126ec2b8ffd
most_likely_to_follow_w = alphabet[findmax(view(sample_freq_matrix, index_of_letter('w'), :))[2]] # replace with your answer
...
most_likely_to_precede_w = alphabet[findmax(view(sample_freq_matrix, :, index_of_letter('w')))[2]] # replace with your answer
...
function matrix_distance(A, B)
	...
	return sum([ sum(view( abs.(A .- B), i, :)) for i in 1:size(A)[1] ]) # do something with A .- B
end
